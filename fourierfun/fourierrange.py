...
class FourierRange2d:
    ...
    def plot_extent(self):
        '''
        Helper function that returns [0, xmax, 0, ymax]. To be used in
        conjunction plt.imshow(). Note that plt.imshow by default centers
        pixels on the data coordinates. This does not happen here necessarily,
        but it does display the interval nicely.
        '''
        return [*self.f_rangex.plot_extent(), *self.f_rangey.plot_extent()]

    def plot_extent_c(self):
        '''
        Helper function that returns [ -xmax/2, xmax/2, -ymax/2, ymax/2]. To be
        used in conjunction plt.imshow(). Note that plt.imshow by default
        centers pixels on the data coordinates. This does not happen here
        necessarily, but it does display the interval nicely.
        '''
        return [*self.f_rangex.plot_extent_c(), *self.f_rangey.plot_extent_c()]

    def plot_extent_fft(self):
        '''
        Helper function that returns [0, kxmax, 0, kymax]. To be used in
        conjunction plt.imshow(). Note that plt.imshow by default centers
        pixels on the data coordinates. This does not happen here necessarily,
        but it does display the interval nicely.
        '''
    ...
    def plot_extent_fft_c(self):
        '''
        Helper function that returns [ -kxmax/2, kxmax/2, -kymax/2, ymax/2]. To be
        used in conjunction plt.imshow(). Note that plt.imshow by default
        centers pixels on the data coordinates. This does not happen here
        necessarily, but it does display the interval nicely.
        '''
...
class FourierRange:
    ...
    def plot_extent(self):
        '''
        Helper function that returns [0, xmax]. To be used in conjunction with
        plt.imshow(). Note that plt.imshow by default centers pixels on the
        data coordinates. This does not happen here necessarily, but it does
        display the interval nicely.
        '''
        return [0, self.xmax]

    def plot_extent_c(self):
        '''
        Helper function that returns [-xmax/2, xmax/2]. To be used in
        conjunction with plt.imshow(). Note that plt.imshow by default centers
        pixels on the data coordinates. This does not happen here necessarily,
        but it does display the interval nicely.
        '''
        return [ - self.xmax/2, self.xmax/2]
        # if self.n%2 == 0:
        #     # even
    ...
    def plot_extent_fft(self):
        '''
        Helper function that returns [0, kmax]. To be used in conjunction with
        plt.imshow(). Note that plt.imshow by default centers pixels on the
        data coordinates. This does not happen here necessarily, but it does
        display the interval nicely.
        '''
    ...
    def plot_extent_fft_c(self):
        '''
        Helper function that returns [-kmax/2, kmax/2]. To be used in
        conjunction with plt.imshow(). Note that plt.imshow by default centers
        pixels on the data coordinates. This does not happen here necessarily,
        but it does display the interval nicely.
        '''
        return [ - self.kmax/2, self.kmax/2]
        # if self.n%2 == 0:
        #     # even
